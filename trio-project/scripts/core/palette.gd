...
const COLORS := {
	...
	&"cliff_face": Color(0.44, 0.47, 0.52),  # 0.466 谷壁前排（偏冷，見下面「為什麼這麼亮」）
	...
	&"stone": Color(0.56, 0.53, 0.45),  # 0.528 **石頭＝爬得上去**（偏暖、比谷壁亮）
	&"corrupt_glow": Color(0.80, 0.28, 0.90),  # 0.435 泥偶自發光、崖底霧氣
	&"cliff_lit": Color(0.50, 0.53, 0.55),  # 0.523 遠山（空氣透視交給霧，不是靠材質變白）
