...
const SHOTS := {
	"res://scenes/world/test_arena.tscn": [
		...
		# 凹室裡面：整片地板是毒液，中央那根 3.6 公尺的柱子頂上是 80 HP 的寶箱。
		# 這一張用固定鏡位：玩家視角的鏡頭是俯角的，六公尺高的箱子會被切掉。
		{"name": "08_chest", "eye": Vector3(22.0, 6.5, 32.0), "at": Vector3(22.0, 4.5, 22.0)},
		{"name": "09_spawn", "x": 0.0, "z": 20.0, "yaw": 0.0},
		{"name": "10_crates", "x": 1.5, "z": 15.0, "yaw": 0.0},
		{"name": "11_vine", "x": 0.0, "z": 13.0, "yaw": 0.0},
		{"name": "12_stump", "x": -1.5, "z": 6.0, "yaw": 0.0},
		{"name": "13_lip", "x": 0.0, "z": -1.0, "yaw": 0.0},
		{"name": "14_bridge", "x": 0.0, "z": -8.0, "yaw": 0.0},
		# 遠岸：台上的壓力板在左手邊，關著的門擋在終點台前面。
		{"name": "15_bankplate", "x": 0.0, "z": -13.5, "yaw": 0.0},
		{"name": "16_goal", "x": 0.0, "z": -14.0, "yaw": 0.0},
		# 回頭往 +z 看：全場最長的視線，也是路面共面 z-fighting 最容易現形的一張。
		{"name": "17_lookback", "x": 0.0, "z": -14.0, "yaw": PI},
