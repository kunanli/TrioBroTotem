...
godot --headless --path trio-project res://scenes/tools/gait_probe.tscn -- --ik=0
```
...
| | 髖起伏 | 髖左右 | 腳滑（全速） |
|---|---|---|---|
| 豬 | 0.0 → **2.0–3.4** | 0.0 → **3.0** | 4.2 → 3.8% |
| 蛙 | 0.0 → **1.6–2.6** | 0.0 → **3.0** | 4.7 → 5.3% |
| 貓 | 0.0 → **2.4–3.6** | 0.0 → **3.0** | 4.9 → 5.4% |

腳滑多了半個百分點，那是髖沉下去時腳要多彎的代價，在圖上看不出來。
